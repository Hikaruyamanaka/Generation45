 ...
 * 1) João, homem de bem, comprou um microcomputador para controlar o rendimento diário de seu trabalho. 
 ...
 pelo regulamento do estado de São Paulo (50 quilos) deve pagar um multa de R$ 4,00 por quilo excedente. 
 ...
 */programa 
{
	...
	funcao inicio()
	{
		...
		escreva("Quantos kgs você comprou?")
		leia(peso)
		f
		se(peso>50)
		{
			...
			escreva("O peso excedeu,o valor de acréscimo é: ", excesso)
			
		}

		senao 
			
			escreva("O valor não excedeu o valor")
